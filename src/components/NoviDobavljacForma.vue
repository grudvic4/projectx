<template>
  <div>
    <b-row class="text-center">
      <b-col cols="12">
        <h1 class="mb-4">Dodaj novog dobavljaca</h1>
      </b-col>
    </b-row>  
    ...
    <b-modal 
      id="success-modal" 
      centered 
      title="Dobavljac uspješno dodan" 
      hide-footer>
      <template v-slot:modal-header="{ close }">
        <h5 class="modal-title">Dobavljac uspješno dodan</h5>
        <b-button class="close" @click="close" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </b-button>
      </template>
      <p class="my-4">Uspješno ste dodali novog dobavljaca</p>
      <b-button variant="primary" @click="$bvModal.hide('success-modal')">Dodaj novog dobavljaca</b-button>
      <b-button class="mx-3" variant="outline-primary" @click="$router.push('/dobavljaci')">Pogledaj dobavljace</b-button>
    </b-modal>
  </div>
</template>
